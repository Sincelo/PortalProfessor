<?php
	...
	{		
		...
		$query2="select d.Abreviatura disciplina, cast (round(avg (ad.Nota),2) AS float) media ".$queryBase."			
		...
		//média por turma
		$query3= "select t.Designacao turmas, cast (round(avg (ad.Nota),2) AS float) media ".$queryBase."
		where m.ID_Curso=".$curso." and ad.AnoLectivo=".$AnoLectivo." and ad.Nota is not null and mm.ID_Ano=".$Ano."
		and ID_AvaliacaoQualitativaDetalhe is null and ad.Nota is not null
		...
		$query11="select md.ID_Ano Ano, md.ID_Disciplina id_d, d.Abreviatura disciplina, cast (round(avg (ad.Nota),2) AS float) media ".$queryBase."				
		...
		$query12="select t.designacao turma, md.ID_Disciplina id_d, d.Abreviatura disciplina, cast (round(avg (ad.Nota),2) AS float) media ".$queryBase."
		where m.ID_Curso=".$curso." and ad.AnoLectivo=".$AnoLectivo." and mal.ID_EscolaMatricula='".$Escola."' and md.ID_Ano=".$Ano." and ID_AvaliacaoQualitativaDetalhe is null and ad.Nota is not null
		group by t.designacao, d.Abreviatura,md.ID_Disciplina, d.Sigla, d.DesignacaoPauta, t.ID_Turma
		order by t.ID_Turma";
		
			
		$query13="select d.Abreviatura Disciplina, md.ID_Disciplina id_d, ad.Nota nota, COUNT(ad.Nota) ocorrencias ".$queryBase."			 
		where m.ID_Curso=".$curso." and ad.AnoLectivo=".$AnoLectivo." and mal.ID_EscolaMatricula='".$Escola."' and md.ID_Ano=".$Ano." and ID_AvaliacaoQualitativaDetalhe is null and ad.Nota is not null
		...
		else
		{
			...
			and mal.DataMatricula<DataFim  and ID_AvaliacaoQualitativaDetalhe is null and ad.Nota is not null";	
			...
			mal.DataMatricula<DataFim and ID_AvaliacaoQualitativaDetalhe is null and ad.Nota is not null
			...
			$query3="select t.Designacao turmas, cast (round(avg (ad.Nota),2) AS float) media ".$queryBase."
				...
				and mal.DataSituacao<DataFim  and ID_AvaliacaoQualitativaDetalhe is null and ad.Nota is not null
				group by ca.ID_Ano
				...
				and mal.DataSituacao<DataFim and ad.nota is not null
				group by ad.Nota,t.Designacao, t.ID_Turma
				order by t.Designacao";
				
				//media por disciplina e ano
				$query11="select ca.ID_Ano Ano, md.ID_Disciplina id_d, d.Abreviatura disciplina, cast (round(avg (ad.Nota),2) AS float) media ".$queryBase."
				...
				$queryMedTurmaAno = "select ca.ID_Ano Ano, t.Designacao turmas, t.ID_Turma id_t, cast (round(avg (ad.Nota),2) AS float) media ".$queryBase."
				where ad.AnoLectivo='".$AnoLectivo."' and mal.ID_EscolaMatricula='".$Escola."' and pl.NPeriodo='".$Periodo."' and ca.ID_Curso='".$curso."'
				and mal.DataSituacao<DataFim  and ID_AvaliacaoQualitativaDetalhe is null and ad.Nota is not null
			...
			$query1="select t.ID_Turma id_t,t.Designacao turma, ut.NomeAbreviado Aluno, ut.ID_NUtente id_a , d.Abreviatura disciplina, d.ID_Disciplina id_d, di.Cod_ENEB eneb, ca.ID_Ano Ano ".$queryBase."
			...
			and mal.DataSituacao<DataFim  and ID_AvaliacaoQualitativaDetalhe is null
		...
		$query9="select d.Abreviatura disciplina,ca.ID_Ano Ano, COUNT (ad.Nota) Negativas ".$queryBase."
